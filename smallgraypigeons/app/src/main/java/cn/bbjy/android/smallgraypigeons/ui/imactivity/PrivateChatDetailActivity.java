...
import cn.bbjy.android.smallgraypigeons.model.bean.SealSearchConversationResult;
...
import cn.bbjy.android.smallgraypigeons.rongyun.OperationRong;
...
import cn.bbjy.android.smallgraypigeons.ui.widget.switchbutton.SwitchButton;
...
public class PrivateChatDetailActivity extends BaseActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppRYCallback.getInstance().pushActivity(this);
    }
...
//            ImageLoader.getInstance().displayImage(portraitUri, mImageView, App.getOptions());
    ...
    protected void onDestroy() {
        ...
        AppRYCallback.getInstance().popActivity(this);
        super.onDestroy();
    }
...
//                Intent searchIntent = new Intent(PrivateChatDetailActivity.this, SealSearchChattingDetailActivity.class);
                ...
                String currentUserId = sp.getString(ConstantUtils.SEALTALK_LOGIN_ID, "");
                String currentUserName = sp.getString(ConstantUtils.SEALTALK_LOGIN_NAME, "");
                String currentUserPortrait = sp.getString(ConstantUtils.SEALTALK_LOGING_PORTRAIT, "");
                if (friend != null) {
                                    ...
                                    RongIM.getInstance().clearMessages(Conversation.ConversationType.PRIVATE,
                                            mUserInfo.getUserId(), new RongIMClient.ResultCallback<Boolean>() {
                                                ...
                                                public void onSuccess(Boolean aBoolean) {
                                                    ToastUtils.getInstance().showLongMsg
                                                            (mContext, getString(R.string.clear_success));
                                                }

                                                @Override
                                                public void onError(RongIMClient.ErrorCode errorCode) {
                                                    ToastUtils.getInstance().showLongMsg(mContext, getString(R.string.clear_failure));
                                                }
                                            });
