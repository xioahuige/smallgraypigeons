...
import cn.bbjy.android.smallgraypigeons.ui.ac.LoginActivity;
import cn.bbjy.android.smallgraypigeons.ui.fragment.ConversationFragmentEx;
import cn.bbjy.android.smallgraypigeons.ui.widget.LoadingDialog;
...
public class ConversationActivity extends BaseActivity implements View.OnClickListener {
        ...
        if (intent.getData().getScheme().equals("rong") && intent.getData().getQueryParameter("isFromPush") != null) {
            ...
            if (intent.getData().getQueryParameter("isFromPush").equals("true")) {
                ...
                if (intent.getData().getPath().contains("conversation/system")) {
                    ...
                    AppRYCallback.getInstance().popAllActivity();
                    return;
                }
                enterActivity();
            } else {
    ...
    private void enterActivity() {
        ...
        String token = (String) SpUtils.get(mContext, ConstantUtils.TOKEN,"");
    ...
    private void enterSettingActivity() {
        ...
        if (mConversationType == Conversation.ConversationType.PUBLIC_SERVICE
            ...
            if (TextUtils.isEmpty(mTargetId)) {
                ToastUtils.getInstance().showLongMsg(mContext, "讨论组尚未创建成功");
            }
