package cn.bbjy.android.smallgraypigeons.model;
...
import cn.bbjy.android.smallgraypigeons.model.db.BlackListDao;
import cn.bbjy.android.smallgraypigeons.model.db.DBManager;
import cn.bbjy.android.smallgraypigeons.model.db.Friend;
import cn.bbjy.android.smallgraypigeons.model.db.FriendDao;
import cn.bbjy.android.smallgraypigeons.model.db.GroupMember;
import cn.bbjy.android.smallgraypigeons.model.db.GroupMemberDao;
import cn.bbjy.android.smallgraypigeons.model.db.Groups;
import cn.bbjy.android.smallgraypigeons.model.db.GroupsDao;
...
import cn.bbjy.android.smallgraypigeons.model.db.BlackList;
import cn.bbjy.android.smallgraypigeons.model.db.BlackListDao;
import cn.bbjy.android.smallgraypigeons.model.db.DBManager;
import cn.bbjy.android.smallgraypigeons.model.db.Friend;
import cn.bbjy.android.smallgraypigeons.model.db.FriendDao;
...
import cn.bbjy.android.smallgraypigeons.model.db.Groups;
import cn.bbjy.android.smallgraypigeons.model.db.GroupsDao;
import cn.bbjy.android.smallgraypigeons.model.db.UserInfoBean;
import cn.bbjy.android.smallgraypigeons.model.network.async.AsyncTaskManager;
import cn.bbjy.android.smallgraypigeons.model.network.async.OnDataListener;
import cn.bbjy.android.smallgraypigeons.model.network.http.HttpException;
import cn.bbjy.android.smallgraypigeons.model.response.GetBlackListResponse;
import cn.bbjy.android.smallgraypigeons.model.response.GetGroupInfoResponse;
import cn.bbjy.android.smallgraypigeons.model.response.GetGroupMemberResponse;
import cn.bbjy.android.smallgraypigeons.model.response.GetGroupResponse;
import cn.bbjy.android.smallgraypigeons.model.response.GetTokenResponse;
import cn.bbjy.android.smallgraypigeons.model.response.UserRelationshipResponse;
import cn.bbjy.android.smallgraypigeons.rongyun.RongGenerate;
            ...
            public void run() {
                if (mFriendDao != null) {
                    if (friend != null) {
                        ...
                        //TODO     mFriendDao.insertOrReplace(friend);
                    }
                }
            }
        });
    ...
    private void syncAddGroup(final Groups groups) {
        if (mGroupsDao != null) {
            if (groups != null) {
                ...
                //TODO      mGroupsDao.insertOrReplace(groups);
            }
        }
    }
            ...
            public void run() {
                if (mGroupMemberDao != null) {
                    if (groupMember != null) {
                        ...
                        //TODO mGroupMemberDao.insertOrReplace(groupMember);
                    }
                }
            }
        });
