...
import cn.bbjy.android.smallgraypigeons.R;
 import cn.bbjy.android.smallgraypigeons.receiver.HomeWatcherReceiver;
import cn.bbjy.android.smallgraypigeons.ui.adapter.ConversationListAdapterEx;
import cn.bbjy.android.smallgraypigeons.ui.fragment.ContactsFragment;
...
public class MainActivityOLD extends FragmentActivity implements
        View.OnClickListener, ViewPager.OnPageChangeListener, IUnReadMessageObserver {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initViews();
        changeTextViewColor();
        initConversationList();initMainViewPager();
    }
                ...
                public void onSuccess(Conversation conversation) {
                    ...
                    if (conversation != null) {
                        ...
                        if (conversation.getLatestMessage() instanceof ContactNotificationMessage) { //好友消息的push
                            /*TODO 待修改
                            startActivity(new Intent(MainActivityOLD.this, NewFriendListActivity.class));*/
                        } else {
 ...
 * */
        ...
        switch (id) {
            case R.id.seal_chat:
                if (mViewPager.getCurrentItem() == 0) {
                    ...
                    RLog.i("MainActivityOLD", "time = " + (secondClick - firstClick));
    ...
    //如果遇见 Android 7.0 系统切换到后台回来无效的情况 把下面注册广播相关代码注释或者删除即可解决。
    // 下面广播重写 home 键是为了解决三星 note3 按 home 键花屏的一个问题
