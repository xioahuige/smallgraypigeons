...
import cn.bbjy.android.smallgraypigeons.model.db.GroupMember;
import cn.bbjy.android.smallgraypigeons.model.db.Groups;
import cn.bbjy.android.smallgraypigeons.model.message.module.SealExtensionModule;
import cn.bbjy.android.smallgraypigeons.model.network.http.HttpException;
import cn.bbjy.android.smallgraypigeons.model.response.ContactNotificationMessageData;
...
import cn.bbjy.android.smallgraypigeons.utils.JsonMananger;
import cn.bbjy.android.smallgraypigeons.utils.NLog;
...
public class AppRYCallback implements
    ...
    RongIM.IGroupMembersProvider {
        ...
        private final static String TAG = "AppRYCallback";
        ...
        private static AppRYCallback mRongCloudInstance;

        private RongIM.LocationProvider.LocationCallback mLastLocationCallback;

        private static ArrayList<Activity> mActivities;

    public AppRYCallback(Context mContext) {
...
/*
        ...
        */
        ...
        public static void init(Context context) {
            ...
            if (mRongCloudInstance == null) {
                synchronized (AppRYCallback.class) {

                    if (mRongCloudInstance == null) {
                        mRongCloudInstance = new AppRYCallback(context);
                    }
                }
            }
        ...
        public static AppRYCallback getInstance() {
 ...
 /*
        ...
        private void initListener() {
            ...
            BroadcastManager.getInstance(mContext).addAction(ConstantUtils.EXIT, new BroadcastReceiver() {
                @Override
        ...
        public boolean onConversationClick(Context context, View view, UIConversation uiConversation) {
            ...
            if (messageContent instanceof ContactNotificationMessage) {
                ...
                if (contactNotificationMessage.getOperation().equals("AcceptResponse")) {
                   ...
                   //TODO context.startActivity(new Intent(context, NewFriendListActivity.class));
                }
                return true;
            }
            return false;
        ...
        public boolean onReceived(Message message, int i) {
            ...
            if (messageContent instanceof ContactNotificationMessage) {
                ...
                if (contactNotificationMessage.getOperation().equals("Request")) {
                    ...
                    try {
                        contactNotificationMessageData = JsonMananger.jsonToBean(contactNotificationMessage.getExtra()
...
//* 发广播通知更新好友列表
                                    ...
                                    if (currentID.equals(userId)) {
                                        ...
                                        RongIM.getInstance().removeConversation(Conversation.ConversationType.GROUP, message.getTargetId(), new RongIMClient.ResultCallback<Boolean>() {
                                            ...
                                            public void onSuccess(Boolean aBoolean) {
                                                Log.e("AppRYCallback", "Conversation remove successfully.");
                                            }
        ...
        private void handleGroupDismiss(final String groupID) {
            ...
            BroadcastManager.getInstance(mContext).sendBroadcast(ConstantUtils.GROUP_LIST_UPDATE);
        ...
        @Override
        public void onStartLocation(Context context, RongIM.LocationProvider.LocationCallback
        locationCallback) {
            /**
...
/**
        ...
        public RongIMClient.ConnectCallback getConnectCallback() {
            RongIMClient.ConnectCallback connectCallback = new RongIMClient.ConnectCallback() {
                ...
                public void onSuccess(String s) {
                    ...
                    sp.edit().putString(ConstantUtils.SEALTALK_LOGIN_ID, s).commit();
                }
        ...
        private void quit(boolean isKicked) {
            ...
            editor.putString(ConstantUtils.SEALTALK_LOGIN_ID, "");
