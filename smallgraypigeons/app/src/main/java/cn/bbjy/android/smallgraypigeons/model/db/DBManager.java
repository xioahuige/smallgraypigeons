package cn.bbjy.android.smallgraypigeons.model.db;
...
public class DBManager {
    ...
    private static String getDbPath () {
        String currentUserId = mContext.getSharedPreferences("config", MODE_PRIVATE).getString(ConstantUtils.SEALTALK_LOGIN_ID, null);
